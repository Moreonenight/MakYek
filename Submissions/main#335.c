...
//尾注
int message1(){/*我们时日已尽。*/}
int message2(){/*新年即将到来。新年已不会到来。*/}
int message3(){/*诅咒将在新旧更迭之际降临。*/}
int message4(){/*这次被毁灭的，是时间本身。*/}
int message5(){/*一切将静止于此。再也不会有任何机会了。*/}
int message6(){/*“就……就这么结束了吗？真的没有办法启动祭坛去第六层了吗……“，Riko喃喃自语，眼中透露着不甘与迷茫。*/}
int message7(){/*祭坛边的水面上漂着一个小小的圆球，粼粼波光闪烁在它的表面。*/}
int message8(){/*似曾相识的感觉挑动着神经。纵身入水，把小球从水中捞起，又将它放在Riko的手中。*/}
int message9(){/*”这是……星之罗盘？！“，Riko对眼前发生的事感到难以置信。*/}
int message10(){/*罗盘的指针并不像之前那样铅直竖立，而是有规律地左右摆动，间或停歇。*/}
int message11(){/*Riko转身从背包中拿出纸笔，一边注视着罗盘，一边在纸上记录着什么。*/}
int message12(){/*”000000000000000000000000000000000100000000000100“*/}
int message13(){/*”000000000000000111000000000000000000000000000000“*/}
int message14(){/*”000000000000000000011100000000000000000000000000“*/}
int message15(){/*”000000000000000000000000001110000000000000000000“*/}
int message16(){/*”000000000000000000000000000000111000000000000000“*/}
int message17(){/*”001000000000001000000000000000000000000000000000“*/}
int message18(){/*”这是什么？“*/}
int message19(){/*Riko没有回答问题，反而径自走入祭坛，拨弄起祭坛中心的圆台。*/}
int message20(){/*隆隆的低响不知从何处传来，地面的震动让即使单纯站立也有些不稳。*/}
int message21(){/*白色光幕在祭坛入口处打开，其上投映着并不熟悉的文字。*/}
int message22(){/*チェンシャンフェイ；ニエイイシン*/}
int message23(){/*”我全都要“，Riko轻声说。*/}
int message24(){/*柔和的光芒笼罩了祭坛，缓缓聚集在Riko身边。*/}
int message25(){/*Riko眼中的怀疑与恐惧渐渐散去，取而代之的是无比的自信和坚定。*/}
int message26(){/*”所以……现在可以到六层了吗？”*/}
int message27(){/*”也许可以”，Riko沉稳地回答，“但对我来说已经没有必要了。”*/}
int message28(){/*”我已经找到了我想要的东西，知道了我想知道的答案。现在，是时候返回了。”*/}